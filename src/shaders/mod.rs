...
impl Shaders {
    pub fn load_shaders(device: Arc<Device>, dimensions: [u32; 2], render_pass: Arc<dyn RenderPassAbstract + Send + Sync>, vs: &vertex_shader::Shader) -> Shaders {
        ...
        let shaders: DashMap<ShaderType, Arc<dyn GraphicsPipelineAbstract + Send + Sync>> = DashMap::with_capacity(2);
